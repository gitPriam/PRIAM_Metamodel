...
public class ToggleCheckboxAction_fii06i_m0 extends AbstractToggleCheckboxAction {
  private final SNode myNode;

  public ToggleCheckboxAction_fii06i_m0(SNode node) {
    myNode = node;
  }

  protected void doExecute() {
    SPropertyOperations.assign(myNode, PROPS.d$ZQqm, !(SPropertyOperations.getBoolean(myNode, PROPS.d$ZQqm)));
  }
