...
public class ToggleCheckboxAction_fii06i_d0 extends AbstractToggleCheckboxAction {
  private final SNode myNode;

  public ToggleCheckboxAction_fii06i_d0(SNode node) {
    myNode = node;
  }

  protected void doExecute() {
    SPropertyOperations.assign(myNode, PROPS.hasPersonalUsage$NmBj, !(SPropertyOperations.getBoolean(myNode, PROPS.hasPersonalUsage$NmBj)));
  }
