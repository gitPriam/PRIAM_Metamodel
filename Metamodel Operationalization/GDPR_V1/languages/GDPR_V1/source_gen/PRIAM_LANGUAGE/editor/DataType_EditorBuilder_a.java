...
/*package*/ class DataType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new dataListHandler_pq0nb8_c0(myNode, getEditorContext());
  ...
  private static class dataListHandler_pq0nb8_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public dataListHandler_pq0nb8_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(dataListHandler_pq0nb8_c0.this.getNode(), LINKS.data$keO4));
      try {
