**Eclipse Papyrus** is a platform to build UML and SysML-based tools. In our case, we use it to check the validity of our metamodel, and in particular the conformity of OCL constraints.
